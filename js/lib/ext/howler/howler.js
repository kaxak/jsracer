...
(function() {
  ...
  var Howl = function(o) {
    ...
    // setup the defaults
    self._isAlreadyPlaying = o.isAlreadyPlaying || false;
  ...
  Howl.prototype = {
    ...
    isAlreadyPlaying: function(isAlreadyPlaying) {
      var self = this;
      
      if (typeof isAlreadyPlaying === 'boolean') {
        self._isAlreadyPlaying = isAlreadyPlaying;
        
        return self;
      } else {
        return self._isAlreadyPlaying;
      }
    },
